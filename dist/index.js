...
var reactPerformance = require('@shopify/react-performance');
var EventEmitter = require('events');
var prom = require('promjs/index');
var reactBeforeunload = require('react-beforeunload');
...
var MetricsContext = /*#__PURE__*/react.createContext({});
...
var MetricsDebugOverlay = function MetricsDebugOverlay(_ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("section", {
    ...
    style: wrapperStyle,
    children: [onClose && /*#__PURE__*/jsxRuntime.jsx("span", {
    ...
    }), navigationData ? /*#__PURE__*/jsxRuntime.jsxs("ul", {
      style: {
        marginLeft: 5
      },
      children: [/*#__PURE__*/jsxRuntime.jsxs("li", {
        children: ["Pathname: ", /*#__PURE__*/jsxRuntime.jsx("span", {
          style: valueStyle,
          children: navigationData.path
        })]
      }), /*#__PURE__*/jsxRuntime.jsxs("li", {
        children: ["Navigation type:", ' ', /*#__PURE__*/jsxRuntime.jsx("span", {
          style: valueStyle,
          children: navigationData.isFullPageNavigation ? 'Full page' : 'In app'
        })]
      }), /*#__PURE__*/jsxRuntime.jsxs("li", {
        children: ["Duration:", ' ', /*#__PURE__*/jsxRuntime.jsxs("span", {
        ...
        children: ["TTU:", ' ', /*#__PURE__*/jsxRuntime.jsxs("span", {
          style: valueStyle,
          children: [navigationData.timeToUsable.toFixed(2), "ms"]
        })]
      }), /*#__PURE__*/jsxRuntime.jsxs("li", {
        children: ["TTC:", ' ', /*#__PURE__*/jsxRuntime.jsxs("span", {
          style: valueStyle,
          children: [navigationData.timeToComplete.toFixed(2), "ms"]
        })]
      })]
    }) : '-', withLogger && /*#__PURE__*/jsxRuntime.jsx(MetricsLogger, {})]
  });
};
...
var MetricsProvider = function MetricsProvider(_ref) {
  ...
  var registry = react.useRef(prom__default.default());
  var eventEmitter = react.useRef(new EventEmitter__default.default());
  var defaultTags = react.useMemo(function () {
    return {
      app_name: appName,
      owner: owner
    };
  }, [appName, owner]);
  var sendMetrics = react.useCallback(function () {
  ...
  var observe = react.useCallback(function (metricName, extraTags, value) {
  ...
  var addObserveListener = react.useCallback(function (callback) {
    eventEmitter.current.on('observation', callback);
  }, []);
  var removeObserveListener = react.useCallback(function (callback) {
  ...
  reactBeforeunload.useBeforeunload(function () {
    observe(GoldenMetrics.AppUnloaded, {}, undefined, true);
    sendMetrics(true);
  });
  reactPerformance.useNavigationListener(function (navigation) {
  ...
  reactPerformance.useLifecycleEventListener(function (_ref2) {
    var type = _ref2.type,
      start = _ref2.start;
  ...
  return /*#__PURE__*/jsxRuntime.jsx(MetricsContext.Provider, {
    value: {
      observe: observe,
      registry: registry.current,
      isReady: isReady,
...
exports.GoldenMetrics = GoldenMetrics;
exports.MetricsContext = MetricsContext;
exports.MetricsDebugOverlay = MetricsDebugOverlay;
exports.MetricsLogger = MetricsLogger;
exports.MetricsProvider = MetricsProvider;
exports.useMetrics = useMetrics;
Object.keys(reactPerformance).forEach(function (k) {
  if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
    enumerable: true,
    get: function () { return reactPerformance[k]; }
  });
});
