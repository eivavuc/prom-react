...
export interface MetricsContextValue {
     ...
     * ```
     */
    observe: (metricName: string, tags?: Record<string, string>, value?: number, skipSending?: boolean) => void;
    /**
...
export declare const MetricsContext: import("react").Context<MetricsContextValue>;
export declare const useMetrics: () => MetricsContextValue;
